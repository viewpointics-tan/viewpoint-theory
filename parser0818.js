 ...
 */ (function() {
  ...
  function peg$parse(input, options) {
    ...
    const peg$c0 = function(vp) {
      return { val: Object.assign(vp, { eva: true }) }
    }
    const peg$c1 = function(pv) {
      return { pos: Object.assign(pv, { eva: true }) }
    }
    ...
    const peg$c4 = function(left, right) {
      return { pv: [left, right] }
    }
    const peg$c5 = function(pos) {
      return { val: Object.assign(pos, { eva: true }) }
    }
    const peg$c6 = '('
    ...
    const peg$c17 = '_'
    const peg$c18 = peg$literalExpectation('_', false)
    const peg$c19 = function(fun) {
      let string = ''
      fun.flat().forEach((l) => {
        string += l
      })
